...
import com.vikaspandey.weatherapp.dashboard.dummy.DummyContent
 ...
 * [FavoriteCitiesFragment.OnListFragmentInteractionListener] interface.
 */
class FavoriteCitiesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyfavoriteRecyclerViewAdapter((activity as LocationListActivity).dbPresenter.loadFabs()!!,
                        object: OnListFragmentInteractionListener {
                            override fun onListFragmentInteraction(city: City?) {
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(city: City?)
    }
